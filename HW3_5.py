...
def my_sum ():
    ...
    ex = False
    while ex == False:
        number = input('Введите числа через пробел для суммирования или Q для выхода - ').split()
        ...
        sum_res = sum_res + res
        print(f'Ваша сумма {sum_res}')
    print(f'Ваша финальная сумма, вы завершили программу {sum_res}')
